...
- a minimal internal close-oriented helper chain that may derive capability-aware close-readiness, close-candidates, minimal close-targets, target-based close-requests, close-requested or close-recorded lifecycle markers, and close-consumer preflight metadata from runtime-context without becoming actual close support, public selectors, or lifecycle truth

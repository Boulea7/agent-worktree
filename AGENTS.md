...
- a minimal internal wait-request layer that may compose an existing wait-target plus explicit wait constraints into a future internal wait-oriented request object without becoming actual wait support, public selectors, persistence, or lifecycle truth

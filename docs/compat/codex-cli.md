...
- public spawn-headless-apply, spawn-headless-execute, spawn-headless-record, spawn-headless-view, spawn-headless-context, or spawn-headless-wait-candidate CLI surface in `agent-worktree`

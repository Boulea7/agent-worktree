...
Promotion currently reaches target and target-apply composition, while handoff and handoff-finalization now extend through request, consumer, consume, apply, outcome-summary, explanation-summary, and report-ready projection composition. Those helper chains remain internal-only.

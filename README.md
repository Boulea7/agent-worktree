...
That internal baseline has also entered an early Phase 5 verification/selection chain: promotion currently reaches target and target-apply composition, while handoff and handoff-finalization now extend through request, consumer, consume, and apply-oriented composition. Those helper chains remain internal-only.

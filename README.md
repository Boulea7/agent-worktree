...
Promotion currently reaches target and target-apply composition, while handoff and handoff-finalization now extend through request, consumer, consume, apply, outcome-summary, explanation-summary, report-ready projection, and grouped projection summary composition. Those helper chains remain internal-only.

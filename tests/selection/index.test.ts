...
// @ts-expect-error selection index must not export promotion audit candidate types
type SelectionIndexShouldNotExportPromotionAuditCandidate = import("../../src/selection/index.js").AttemptPromotionAuditCandidate;
...
// @ts-expect-error selection index must not export promotion decision blocking reason types
type SelectionIndexShouldNotExportPromotionDecisionBlockingReason = import("../../src/selection/index.js").AttemptPromotionDecisionBlockingReason;
...
// @ts-expect-error selection index must not export handoff consumer blocking reason types
type SelectionIndexShouldNotExportHandoffConsumerBlockingReason = import("../../src/selection/index.js").AttemptHandoffConsumerBlockingReason;

// @ts-expect-error selection index must not export handoff capability resolver types
type SelectionIndexShouldNotExportHandoffCapabilityResolver = import("../../src/selection/index.js").AttemptHandoffCapabilityResolver;
...
// @ts-expect-error selection index must not export handoff consume-batch input types
type SelectionIndexShouldNotExportHandoffConsumeBatchInput = import("../../src/selection/index.js").AttemptHandoffConsumeBatchInput;

// @ts-expect-error selection index must not export handoff consume-batch result types
type SelectionIndexShouldNotExportHandoffConsumeBatch = import("../../src/selection/index.js").AttemptHandoffConsumeBatch;
...
// @ts-expect-error selection index must not export handoff apply-batch result types
type SelectionIndexShouldNotExportHandoffApplyBatch = import("../../src/selection/index.js").AttemptHandoffApplyBatch;
...
// @ts-expect-error selection index must not export promotion target apply-batch input types
type SelectionIndexShouldNotExportPromotionTargetApplyBatchInput = import("../../src/selection/index.js").AttemptPromotionTargetApplyBatchInput;

// @ts-expect-error selection index must not export promotion target apply-batch result types
type SelectionIndexShouldNotExportPromotionTargetApplyBatch = import("../../src/selection/index.js").AttemptPromotionTargetApplyBatch;

// @ts-expect-error selection index must not export handoff target apply input types
type SelectionIndexShouldNotExportHandoffTargetApplyInput = import("../../src/selection/index.js").AttemptHandoffTargetApplyInput;

// @ts-expect-error selection index must not export handoff target apply result types
type SelectionIndexShouldNotExportHandoffTargetApply = import("../../src/selection/index.js").AttemptHandoffTargetApply;

// @ts-expect-error selection index must not export handoff target apply-batch input types
type SelectionIndexShouldNotExportHandoffTargetApplyBatchInput = import("../../src/selection/index.js").AttemptHandoffTargetApplyBatchInput;
...
// @ts-expect-error selection index must not export handoff target helpers
type SelectionIndexShouldNotExportDeriveAttemptHandoffTarget = typeof import("../../src/selection/index.js").deriveAttemptHandoffTarget;

// @ts-expect-error selection index must not export promotion target helpers
type SelectionIndexShouldNotExportDeriveAttemptPromotionTarget = typeof import("../../src/selection/index.js").deriveAttemptPromotionTarget;

// @ts-expect-error selection index must not export handoff batch apply helpers
type SelectionIndexShouldNotExportApplyAttemptHandoffBatch = typeof import("../../src/selection/index.js").applyAttemptHandoffBatch;

// @ts-expect-error selection index must not export handoff batch consume helpers
type SelectionIndexShouldNotExportConsumeAttemptHandoffBatch = typeof import("../../src/selection/index.js").consumeAttemptHandoffBatch;

// @ts-expect-error selection index must not export handoff target apply helpers
type SelectionIndexShouldNotExportApplyAttemptHandoffTarget = typeof import("../../src/selection/index.js").applyAttemptHandoffTarget;

// @ts-expect-error selection index must not export handoff target apply batch helpers
type SelectionIndexShouldNotExportApplyAttemptHandoffTargetBatch = typeof import("../../src/selection/index.js").applyAttemptHandoffTargetBatch;

// @ts-expect-error selection index must not export promotion target apply helpers
type SelectionIndexShouldNotExportApplyAttemptPromotionTarget = typeof import("../../src/selection/index.js").applyAttemptPromotionTarget;

// @ts-expect-error selection index must not export promotion target apply batch helpers
type SelectionIndexShouldNotExportApplyAttemptPromotionTargetBatch = typeof import("../../src/selection/index.js").applyAttemptPromotionTargetBatch;
...
// @ts-expect-error selection index must not export handoff finalization request-summary apply helpers
type SelectionIndexShouldNotExportApplyAttemptHandoffFinalizationRequestSummary = typeof import("../../src/selection/index.js").applyAttemptHandoffFinalizationRequestSummary;
...
// @ts-expect-error selection index must not export handoff finalization closeout summary helpers
type SelectionIndexShouldNotExportDeriveAttemptHandoffFinalizationCloseoutSummary = typeof import("../../src/selection/index.js").deriveAttemptHandoffFinalizationCloseoutSummary;
...
// @ts-expect-error selection index must not export handoff finalization closeout decision apply helpers
type SelectionIndexShouldNotExportApplyAttemptHandoffFinalizationCloseoutDecisionSummary = typeof import("../../src/selection/index.js").applyAttemptHandoffFinalizationCloseoutDecisionSummary;
